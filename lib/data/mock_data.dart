  ...
  static List<Animal> generateAnimals() {
    ...
    return [
      ...
      Animal(
        ...
        createdAt: now.subtract(Duration(days: 290)),
      ...
      Animal(
        ...
        sex: AnimalSex.female,
        status: AnimalStatus.alive,
        createdAt: now.subtract(Duration(days: 820)),
        updatedAt: now.subtract(Duration(days: 3)),
      ),
      Animal(
        id: 'animal_021',
        ...
        sex: AnimalSex.female,
        status: AnimalStatus.alive,
        createdAt: now.subtract(Duration(days: 793)),
      ...
      Animal(
        ...
        motherId: 'animal_001',
        status: AnimalStatus.alive,
        createdAt: now.subtract(Duration(days: 615)),
        updatedAt: now.subtract(Duration(days: 12)),
      ),
      Animal(
        id: 'animal_023',
        eid: '250001234567823',
        ...
        motherId: 'animal_002',
        status: AnimalStatus.alive,
        createdAt: now.subtract(Duration(days: 602)),
      ...
      Animal(
        ...
        motherId: 'animal_003',
        status: AnimalStatus.alive,
        createdAt: now.subtract(Duration(days: 558)),
        updatedAt: now.subtract(Duration(days: 1)),
      ),
      Animal(
        id: 'animal_025',
        ...
        motherId: 'animal_004',
        status: AnimalStatus.alive,
        createdAt: now.subtract(Duration(days: 524)),
        updatedAt: now,
      ),
      Animal(
        id: 'animal_026',
        ...
        motherId: 'animal_005',
        status: AnimalStatus.alive,
        createdAt: now.subtract(Duration(days: 505)),
      ...
      Animal(
        ...
        sex: AnimalSex.female,
        status: AnimalStatus.alive,
        createdAt: now.subtract(Duration(days: 482)),
        updatedAt: now.subtract(Duration(days: 5)),
      ),
      Animal(
        id: 'animal_028',
        ...
        motherId: 'animal_020',
        status: AnimalStatus.alive,
        createdAt: now.subtract(Duration(days: 439)),
        updatedAt: now.subtract(Duration(days: 2)),
      ),
      Animal(
        id: 'animal_029',
        ...
        motherId: 'animal_021',
        status: AnimalStatus.alive,
        createdAt: now.subtract(Duration(days: 403)),
      ...
      Animal(
        ...
        motherId: 'animal_020',
        status: AnimalStatus.alive,
        createdAt: now.subtract(Duration(days: 221)),
        updatedAt: now.subtract(Duration(days: 4)),
      ),
      Animal(
        id: 'animal_031',
        ...
        motherId: 'animal_021',
        status: AnimalStatus.alive,
        createdAt: now.subtract(Duration(days: 218)),
        updatedAt: now.subtract(Duration(days: 1)),
      ),
      Animal(
        id: 'animal_032',
        ...
        motherId: 'animal_022',
        status: AnimalStatus.alive,
        createdAt: now.subtract(Duration(days: 214)),
        updatedAt: now,
      ),
      Animal(
        id: 'animal_033',
        ...
        motherId: 'animal_023',
        status: AnimalStatus.alive,
        createdAt: now.subtract(Duration(days: 204)),
        updatedAt: now.subtract(Duration(days: 3)),
      ),
      Animal(
        id: 'animal_034',
      ...
      Animal(
        ...
        motherId: 'animal_025',
        status: AnimalStatus.alive,
        createdAt: now.subtract(Duration(days: 195)),
        updatedAt: now,
      ),
      Animal(
        id: 'animal_036',
        ...
        motherId: 'animal_026',
        status: AnimalStatus.alive,
        createdAt: now.subtract(Duration(days: 190)),
        updatedAt: now.subtract(Duration(days: 1)),
      ),
      Animal(
        id: 'animal_037',
        ...
        motherId: 'animal_027',
        status: AnimalStatus.alive,
        createdAt: now.subtract(Duration(days: 185)),
        updatedAt: now.subtract(Duration(days: 5)),
      ),
      Animal(
        id: 'animal_038',
      ...
      Animal(
        ...
        motherId: 'animal_029',
        status: AnimalStatus.alive,
        createdAt: now.subtract(Duration(days: 174)),
        updatedAt: now.subtract(Duration(days: 2)),
      ),
      Animal(
        id: 'animal_040',
        ...
        motherId: 'animal_001',
        status: AnimalStatus.alive,
        createdAt: now.subtract(Duration(days: 170)),
        updatedAt: now,
      ),
      Animal(
        id: 'animal_041',
        ...
        motherId: 'animal_002',
        status: AnimalStatus.alive,
        createdAt: now.subtract(Duration(days: 165)),
        updatedAt: now.subtract(Duration(days: 1)),
      ),
      Animal(
        id: 'animal_042',
        ...
        motherId: 'animal_003',
        status: AnimalStatus.alive,
        createdAt: now.subtract(Duration(days: 160)),
        updatedAt: now.subtract(Duration(days: 4)),
      ),
      Animal(
        id: 'animal_043',
        ...
        motherId: 'animal_004',
        status: AnimalStatus.alive,
        createdAt: now.subtract(Duration(days: 155)),
        updatedAt: now.subtract(Duration(days: 2)),
      ),
      Animal(
        id: 'animal_044',
  ...
  static List<WeightRecord> generateWeightRecords() {
    ...
    return [
      ...
      WeightRecord(
        ...
        animalId: 'animal_001',
        weight: 52.3,
        recordedAt: now.subtract(Duration(days: 365)),
      ...
      WeightRecord(
        ...
        animalId: 'animal_009',
        weight: 4.5,
        recordedAt: now.subtract(Duration(days: 250)),
      ...
      WeightRecord(
        ...
        animalId: 'animal_009',
        weight: 12.8,
        recordedAt: now.subtract(Duration(days: 220)),
        source: WeightSource.manual,
        synced: true,
        createdAt: now.subtract(Duration(days: 220)),
      ),
      WeightRecord(
        id: 'weight_006',
        animalId: 'animal_009',
      ...
      WeightRecord(
        ...
        animalId: 'animal_009',
        weight: 38.9,
        recordedAt: now.subtract(Duration(days: 60)),
        source: WeightSource.scale,
        synced: true,
  ...
  static List<Treatment> generateTreatments() {
    ...
    return [
      ...
      Treatment(
        ...
        dose: 15.0,
        treatmentDate: now.subtract(Duration(days: 10)),
        withdrawalEndDate:
            now.add(Duration(days: 18)), // 28j - 10j = 18j restants
      ...
      Treatment(
        ...
        dose: 0.5,
        treatmentDate: now.subtract(Duration(days: 3)),
        withdrawalEndDate: now.add(Duration(days: 2)), // 5j - 3j = 2j restants
        veterinarianId: 'vet_001',
        veterinarianName: 'Dr. Sarah Dubois',
        synced: false,
  ...
  static List<Veterinarian> generateVeterinarians() {
    ...
    return [
      Veterinarian(
        ...
        lastInterventionDate: now.subtract(Duration(days: 5)),
      ...
      Veterinarian(
        ...
        lastInterventionDate: now.subtract(Duration(days: 15)),
        createdAt: now.subtract(Duration(days: 600)),
        updatedAt: now.subtract(Duration(days: 15)),
        isActive: true,
      ),
      Veterinarian(
        ...
        lastInterventionDate: now.subtract(Duration(days: 30)),
      ...
      Veterinarian(
        ...
        lastInterventionDate: now.subtract(Duration(days: 8)),
      ...
      Veterinarian(
        ...
        lastInterventionDate: now.subtract(Duration(days: 60)),
        createdAt: now.subtract(Duration(days: 365)),
        updatedAt: now.subtract(Duration(days: 60)),
        isActive: true,
      ),
  ...
  static List<Batch> generateBatches() {
    ...
    return [
      ...
      Batch(
        ...
        createdAt: now.subtract(Duration(days: 60)),
        usedAt: now.subtract(Duration(days: 58)),
        completed: true,
        synced: true,
      ...
      Batch(
        ...
        createdAt: now.subtract(Duration(days: 90)),
        usedAt: now.subtract(Duration(days: 80)),
        completed: true,
        synced: true,
  ...
  static List<Campaign> generateCampaigns() {
    ...
    return [
      Campaign(
        ...
        completed: true,
        synced: true,
        createdAt: now.subtract(Duration(days: 240)),
      ),
      Campaign(
        id: 'campaign_002',
      ...
      Campaign(
        ...
        productId: 'product_001',
        productName: 'Ivermectine 1%',
        campaignDate: now.subtract(Duration(days: 30)),
        withdrawalEndDate: now.subtract(Duration(days: 14)), // 16 jours après
        veterinarianId: 'vet_001',
        veterinarianName: 'Dr. Sarah Dubois',
        animalIds: [
          'animal_020',
        ...
        completed: true,
        synced: true,
        createdAt: now.subtract(Duration(days: 32)),
      ),
      Campaign(
        id: 'campaign_004',
        ...
        campaignDate: now.add(Duration(days: 15)),
        withdrawalEndDate: now.add(Duration(days: 15)), // Pas de délai
        veterinarianId: 'vet_002',
        veterinarianName: 'Dr. Mohammed Alami',
        animalIds: [
          'animal_014',
