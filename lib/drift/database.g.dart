...
class $AnimalsTableTable extends AnimalsTable
  ...
  late final GeneratedColumn<String> farmId = GeneratedColumn<String>(
      'farm_id', aliasedName, false,
      type: DriftSqlType.string, requiredDuringInsert: true);
  static const VerificationMeta _currentLocationFarmIdMeta =
      const VerificationMeta('currentLocationFarmId');
  @override
  late final GeneratedColumn<String> currentLocationFarmId =
      GeneratedColumn<String>('current_location_farm_id', aliasedName, true,
          type: DriftSqlType.string, requiredDuringInsert: false);
  ...
  VerificationContext validateIntegrity(Insertable<AnimalsTableData> instance,
    ...
    if (data.containsKey('current_location_farm_id')) {
      context.handle(
          _currentLocationFarmIdMeta,
          currentLocationFarmId.isAcceptableOrUnknown(
              data['current_location_farm_id']!, _currentLocationFarmIdMeta));
    }
  ...
  AnimalsTableData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return AnimalsTableData(
      ...
      farmId: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}farm_id'])!,
      currentLocationFarmId: attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}current_location_farm_id']),
...
class AnimalsTableData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['id'] = Variable<String>(id);
    map['farm_id'] = Variable<String>(farmId);
    if (!nullToAbsent || currentLocationFarmId != null) {
      map['current_location_farm_id'] = Variable<String>(currentLocationFarmId);
    }
  ...
  AnimalsTableCompanion toCompanion(bool nullToAbsent) {
    return AnimalsTableCompanion(
      id: Value(id),
      farmId: Value(farmId),
      currentLocationFarmId: currentLocationFarmId == null && nullToAbsent
          ? const Value.absent()
          : Value(currentLocationFarmId),
  ...
  factory AnimalsTableData.fromJson(Map<String, dynamic> json,
    ...
    return AnimalsTableData(
      ...
      farmId: serializer.fromJson<String>(json['farmId']),
      currentLocationFarmId:
          serializer.fromJson<String?>(json['currentLocationFarmId']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'farmId': serializer.toJson<String>(farmId),
      'currentLocationFarmId':
          serializer.toJson<String?>(currentLocationFarmId),
  ...
  AnimalsTableData copyWith(
          {String? id,
          String? farmId,
          Value<String?> currentLocationFarmId = const Value.absent(),
      ...
      AnimalsTableData(
        id: id ?? this.id,
        farmId: farmId ?? this.farmId,
        currentLocationFarmId: currentLocationFarmId.present
            ? currentLocationFarmId.value
            : this.currentLocationFarmId,
  ...
  AnimalsTableData copyWithCompanion(AnimalsTableCompanion data) {
    return AnimalsTableData(
      id: data.id.present ? data.id.value : this.id,
      farmId: data.farmId.present ? data.farmId.value : this.farmId,
      currentLocationFarmId: data.currentLocationFarmId.present
          ? data.currentLocationFarmId.value
          : this.currentLocationFarmId,
      currentEid:
  ...
  String toString() {
    return (StringBuffer('AnimalsTableData(')
          ..write('id: $id, ')
          ..write('farmId: $farmId, ')
          ..write('currentLocationFarmId: $currentLocationFarmId, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is AnimalsTableData &&
          other.id == this.id &&
          other.farmId == this.farmId &&
          other.currentLocationFarmId == this.currentLocationFarmId &&
...
class AnimalsTableCompanion extends UpdateCompanion<AnimalsTableData> {
  final Value<String> id;
  final Value<String> farmId;
  final Value<String?> currentLocationFarmId;
  ...
  const AnimalsTableCompanion({
    this.id = const Value.absent(),
    this.farmId = const Value.absent(),
    this.currentLocationFarmId = const Value.absent(),
  ...
  static Insertable<AnimalsTableData> custom({
    Expression<String>? id,
    Expression<String>? farmId,
    Expression<String>? currentLocationFarmId,
  ...
  AnimalsTableCompanion copyWith(
      {Value<String>? id,
      Value<String>? farmId,
      Value<String?>? currentLocationFarmId,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (currentLocationFarmId.present) {
      map['current_location_farm_id'] =
          Variable<String>(currentLocationFarmId.value);
    }
...
class $MovementsTableTable extends MovementsTable
  ...
  late final GeneratedColumn<String> buyerFarmId = GeneratedColumn<String>(
      ...
      type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _buyerTypeMeta =
      const VerificationMeta('buyerType');
  @override
  late final GeneratedColumn<String> buyerType = GeneratedColumn<String>(
      'buyer_type', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  ...
  late final GeneratedColumn<bool> isTemporary = GeneratedColumn<bool>(
      ...
      defaultValue: const Constant(false));
  static const VerificationMeta _temporaryMovementTypeMeta =
      const VerificationMeta('temporaryMovementType');
  @override
  late final GeneratedColumn<String> temporaryMovementType =
      GeneratedColumn<String>('temporary_movement_type', aliasedName, true,
          type: DriftSqlType.string, requiredDuringInsert: false);
  ...
  @override
  late final GeneratedColumn<String> relatedMovementId =
      GeneratedColumn<String>('related_movement_id', aliasedName, true,
          type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _statusMeta = const VerificationMeta('status');
  @override
  late final GeneratedColumn<String> status = GeneratedColumn<String>(
  ...
  VerificationContext validateIntegrity(Insertable<MovementsTableData> instance,
    ...
    if (data.containsKey('buyer_type')) {
      context.handle(_buyerTypeMeta,
          buyerType.isAcceptableOrUnknown(data['buyer_type']!, _buyerTypeMeta));
    }
    ...
    if (data.containsKey('temporary_movement_type')) {
      context.handle(
          _temporaryMovementTypeMeta,
          temporaryMovementType.isAcceptableOrUnknown(
              data['temporary_movement_type']!, _temporaryMovementTypeMeta));
    }
    ...
    if (data.containsKey('related_movement_id')) {
      context.handle(
          ...
          relatedMovementId.isAcceptableOrUnknown(
              data['related_movement_id']!, _relatedMovementIdMeta));
    }
    if (data.containsKey('status')) {
      context.handle(_statusMeta,
          status.isAcceptableOrUnknown(data['status']!, _statusMeta));
  ...
  MovementsTableData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return MovementsTableData(
      ...
      buyerType: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}buyer_type']),
      ...
      temporaryMovementType: attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}temporary_movement_type']),
...
class MovementsTableData extends DataClass
  ...
  final String? temporaryMovementType;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || buyerType != null) {
      map['buyer_type'] = Variable<String>(buyerType);
    }
    ...
    if (!nullToAbsent || temporaryMovementType != null) {
      map['temporary_movement_type'] = Variable<String>(temporaryMovementType);
    }
  ...
  MovementsTableCompanion toCompanion(bool nullToAbsent) {
    return MovementsTableCompanion(
      ...
      buyerFarmId: buyerFarmId == null && nullToAbsent
          ? const Value.absent()
          : Value(buyerFarmId),
      buyerType: buyerType == null && nullToAbsent
          ? const Value.absent()
          : Value(buyerType),
      ...
      temporaryMovementType: temporaryMovementType == null && nullToAbsent
          ? const Value.absent()
          : Value(temporaryMovementType),
  ...
  factory MovementsTableData.fromJson(Map<String, dynamic> json,
    ...
    return MovementsTableData(
      ...
      buyerType: serializer.fromJson<String?>(json['buyerType']),
      slaughterhouseName:
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'buyerType': serializer.toJson<String?>(buyerType),
  ...
  MovementsTableData copyWith(
          ...
          Value<String?> buyerType = const Value.absent(),
      ...
      MovementsTableData(
        ...
        buyerType: buyerType.present ? buyerType.value : this.buyerType,
        ...
        temporaryMovementType: temporaryMovementType.present
            ? temporaryMovementType.value
            : this.temporaryMovementType,
  ...
  MovementsTableData copyWithCompanion(MovementsTableCompanion data) {
    return MovementsTableData(
      ...
      buyerType: data.buyerType.present ? data.buyerType.value : this.buyerType,
      ...
      temporaryMovementType: data.temporaryMovementType.present
          ? data.temporaryMovementType.value
          : this.temporaryMovementType,
  ...
  bool operator ==(Object other) =>
      ...
      (other is MovementsTableData &&
          ...
          other.buyerType == this.buyerType &&
...
class MovementsTableCompanion extends UpdateCompanion<MovementsTableData> {
  ...
  const MovementsTableCompanion({
    ...
    this.buyerType = const Value.absent(),
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (buyerType.present) {
      map['buyer_type'] = Variable<String>(buyerType.value);
    }
    ...
    if (temporaryMovementType.present) {
      map['temporary_movement_type'] =
          Variable<String>(temporaryMovementType.value);
    }
...
class $$AnimalsTableTableFilterComposer
  ...
  ColumnFilters<String> get currentLocationFarmId => $composableBuilder(
      column: $table.currentLocationFarmId,
      builder: (column) => ColumnFilters(column));
...
class $$AnimalsTableTableOrderingComposer
  ...
  ColumnOrderings<String> get currentLocationFarmId => $composableBuilder(
      column: $table.currentLocationFarmId,
      builder: (column) => ColumnOrderings(column));
...
class $$AnimalsTableTableAnnotationComposer
  ...
  GeneratedColumn<String> get currentLocationFarmId => $composableBuilder(
      column: $table.currentLocationFarmId, builder: (column) => column);
  ...
  $$AnimalsTableTableTableManager(_$AppDatabase db, $AnimalsTableTable table)
      : super(TableManagerState(
          ...
          updateCompanionCallback: ({
            ...
            id: id,
            farmId: farmId,
            currentLocationFarmId: currentLocationFarmId,
...
class $$MovementsTableTableFilterComposer
  ...
  ColumnFilters<String> get buyerType => $composableBuilder(
      column: $table.buyerType, builder: (column) => ColumnFilters(column));
  ...
  ColumnFilters<String> get temporaryMovementType => $composableBuilder(
      column: $table.temporaryMovementType,
      builder: (column) => ColumnFilters(column));
...
class $$MovementsTableTableOrderingComposer
  ...
  ColumnOrderings<String> get buyerType => $composableBuilder(
      column: $table.buyerType, builder: (column) => ColumnOrderings(column));
  ...
  ColumnOrderings<String> get temporaryMovementType => $composableBuilder(
      column: $table.temporaryMovementType,
      builder: (column) => ColumnOrderings(column));
...
class $$MovementsTableTableAnnotationComposer
  ...
  GeneratedColumn<String> get buyerType =>
      $composableBuilder(column: $table.buyerType, builder: (column) => column);
  ...
  GeneratedColumn<String> get temporaryMovementType => $composableBuilder(
      column: $table.temporaryMovementType, builder: (column) => column);
