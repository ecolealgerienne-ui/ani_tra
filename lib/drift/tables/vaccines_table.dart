...
class VaccinesTable extends Table {
  ...
  IntColumn get injectionsRequired => integer().nullable().named('injections_required')();
  IntColumn get injectionIntervalDays => integer().nullable().named('injection_interval_days')();
  ...
  // === Administration ===
  TextColumn get administrationRoute => text().nullable().named('administration_route')();
