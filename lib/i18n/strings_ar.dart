...
const Map<String, String> stringsAr = {
  ...
  'movementNotFound': 'الحركة غير موجودة',
  'noMovements': 'لا توجد حركات',
  'noMovementsSubtitle': 'ستظهر حركات الحيوانات هنا',
  'filterByType': 'تصفية حسب النوع',
  'purchases': 'المشتريات',
  'sales': 'المبيعات',
  'deaths': 'النفوقات',
  'slaughters': 'الذبح',
  'temporaryOuts': 'الخروج المؤقت',
  'financialInfo': 'المعلومات المالية',
  'syncInfo': 'معلومات المزامنة',
  'fromFarm': 'المنشأ',
  'toFarm': 'الوجهة',
  ...
  // ==================== واجهة تصحيح المزامنة (STEP 4) ====================
  'syncQueueDebug': 'تصحيح قائمة المزامنة',
  'syncQueueTitle': 'قائمة المزامنة',
  'clearQueue': 'مسح القائمة',
  'clearQueueConfirm': 'هل تريد مسح جميع العناصر المعلقة؟',
  'queueCleared': 'تم مسح القائمة',
  'retryAll': 'إعادة المحاولة للكل',
  'retryAllConfirm': 'إعادة تعيين محاولات جميع العناصر الفاشلة؟',
  'retriesReset': 'تمت إعادة تعيين المحاولات',
  'pendingItems': 'عناصر معلقة',
  'stalledItems': 'عناصر فاشلة',
  'noItemsInQueue': 'لا توجد عناصر في القائمة',
  'entityType': 'نوع الكيان',
  'action': 'الإجراء',
  'retryCount': 'عدد المحاولات',
  'lastError': 'آخر خطأ',
  'payload': 'البيانات',
  'viewPayload': 'عرض البيانات',
  'payloadDetails': 'تفاصيل البيانات',
  'copyPayload': 'نسخ',
  'payloadCopied': 'تم نسخ البيانات',
  'retryItem': 'إعادة المحاولة',
  'deleteItem': 'حذف العنصر',
  'deleteItemConfirm': 'هل تريد حذف هذا العنصر من القائمة؟',
  'itemDeleted': 'تم حذف العنصر',
  'itemRetryReset': 'تمت إعادة تعيين محاولة العنصر',
  'syncEnabled': 'المزامنة مفعّلة',
  'syncDisabled': 'المزامنة معطّلة',
  'toggleSync': 'تبديل المزامنة',
  'syncStats': 'إحصائيات المزامنة',
  'totalItems': 'إجمالي العناصر',
  'byEntity': 'حسب الكيان',
  'refreshStats': 'تحديث الإحصائيات',
  'queueEmpty': 'القائمة فارغة',
  'officialNumberRequired': 'الرقم الرسمي مطلوب للمزامنة',
  'atLeastOneIdentifierRequired': 'مطلوب معرّف واحد على الأقل',
  'animalIdEmpty': 'معرّف الحيوان فارغ',
  'farmIdEmpty': 'معرّف المزرعة فارغ',
  'syncBlocked': 'المزامنة محظورة',
