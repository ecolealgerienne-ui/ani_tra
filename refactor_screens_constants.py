#!/usr/bin/env python3
"""
Comprehensive script to replace hardcoded values with AppConstants across all screen files.
Processes 25+ screen files systematically.
"""
...
# Comprehensive mapping of hardcoded values to constants
VALUE_MAPPINGS = {
    # ============ SPACING (for SizedBox, EdgeInsets, padding) ============
    '2': 'spacingMicro',
    '2.0': 'spacingMicro',
    '4': 'spacingTiny',
    '4.0': 'spacingTiny',
    '6': 'borderRadiusSmall',  # Also used for spacing sometimes
    '6.0': 'borderRadiusSmall',
    '8': 'spacingExtraSmall',
    '8.0': 'spacingExtraSmall',
    '10': 'fontSizeMicro',  # Context-dependent
    '10.0': 'fontSizeMicro',
    '12': 'spacingSmall',
    '12.0': 'spacingSmall',
    '14': 'fontSizeBody',  # Context-dependent
    '14.0': 'fontSizeBody',
    '16': 'spacingMedium',
    '16.0': 'spacingMedium',
    '18': 'fontSizeImportant',  # Context-dependent
    '18.0': 'fontSizeImportant',
    '20': 'iconSizeRegular',  # Context-dependent
    '20.0': 'iconSizeRegular',
    '24': 'spacingMediumLarge',
    '24.0': 'spacingMediumLarge',
    '28': 'iconSizeMedium',  # Context-dependent (actually 32)
    '28.0': 'iconSizeMedium',
    '32': 'spacingLarge',
    '32.0': 'spacingLarge',
    '36': 'iconSizeExtraLarge',
    '36.0': 'iconSizeExtraLarge',
    '40': 'avatarRadiusLarge',
    '40.0': 'avatarRadiusLarge',
    '48': 'spacingXLarge',
    '48.0': 'spacingXLarge',
    '64': 'iconSizeLarge',
    '64.0': 'iconSizeLarge',
    '80': 'iconSizeHuge',
    '80.0': 'iconSizeHuge',
    '100': 'scanButtonHeight',
    '100.0': 'scanButtonHeight',
    '120': 'syncButtonHeight',
    '120.0': 'syncButtonHeight',
}
...
ICON_SIZE_MAP = {
    ...
    '24': 'iconSizeMedium',
    '24.0': 'iconSizeMedium',
    '28': 'iconSizeMedium',  # Close enough to 32
    '28.0': 'iconSizeMedium',
    '32': 'iconSizeMedium',
    '32.0': 'iconSizeMedium',
    '36': 'iconSizeExtraLarge',
...
def replace_in_file(file_path):
    ...
    # 1. Replace fontSize: X with fontSize: AppConstants.fontSizeX
    ...
    # 2. Replace size: X with size: AppConstants.iconSizeX (for Icon widgets)
    ...
    for value, const_name in BORDER_RADIUS_MAP.items():
        ...
        new_content = re.sub(pattern, replacement, content)
        if new_content != content:
            replacements += content.count(f'BorderRadius.circular({value})') - new_content.count(f'BorderRadius.circular({value})')
            content = new_content
    ...
    # This is trickier - need to handle both horizontal and vertical
    ...
    # 8. Replace width: X, height: X in Container/SizedBox
    for value, const_name in SPACING_MAP.items():
    ...
    if content != original_content and not has_constants_import:
        # Count directory depth to determine correct import path
        depth = str(file_path).count('lib/')
        if 'lib/screens/' in str(file_path):
...
def main():
    ...
    screens_dir = Path('/home/user/ani_tra/lib/screens')

    # Find all .dart files
    dart_files = list(screens_dir.rglob('*.dart'))

    # Exclude animal_list_screen.dart (already done)
    dart_files = [f for f in dart_files if 'animal_list_screen.dart' not in str(f)]

    print(f"Found {len(dart_files)} screen files to process")
    print("=" * 80)
    ...
    print("\nDone! Please run 'flutter analyze' to verify.")
